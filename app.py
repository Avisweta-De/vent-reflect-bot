...
if vent:
    ...
    if st.button("💾 Save Entry"):
        ...
        with open("vent_log.txt", "a", encoding="utf-8") as f:
            f.write(log)

        st.success("✅ Your entry has been saved.")

if st.checkbox("📚 View Past Entries"):
    try:
        with open("vent_log.txt", "r", encoding="utf-8") as f:
            st.text(f.read())
    except FileNotFoundError:
        st.warning("No previous entries found.")
